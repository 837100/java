...
public class SnailGameMain {
	...
	public static void main(String[] args) {
		...
		for(int round=0;round<100;round++){
			System.out.println();
			System.out.println(player1.getName()+"님 나아간 칸 :"+player1howgoing
			+"진행한 라운드"+player1round);
			statusView.statusView(player1howgoing);

			System.out.println();
			System.out.println(player2.getName()+"님 나아간 칸 :"+player2howgoing
					+"진행한 라운드"+player2round);
			...
			if((player1howgoing >= 50) && (player1round==player2round) && (player1howgoing>player2howgoing)){
				...
				break;
			} else if((player2howgoing >= 50) && (player1round==player2round) && (player2howgoing>player1howgoing)){
